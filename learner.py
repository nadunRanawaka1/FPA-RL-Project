...
class Learner:
	def __init__(self):
		...
		self.T = 50# Max time steps for the exploration (i.e., policy roll-out)
		self.episodes = 10000 #number of training episodes to run
		self.gamma = 0.95  # discount factor
		self.epsilon = 0.7 #episilon for epsilon-greedy rollouts
		...
		self.batchSize = 5 #batchsize when optimizing the model
